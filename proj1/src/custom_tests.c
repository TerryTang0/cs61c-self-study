...
bool test_get_next_row() {
  // TODO: Implement this function.
  unsigned int cur_row = 3;

  unsigned int output_1 = get_next_row(cur_row, 'v');
  if (!assert_equals_int("output_1", 4, (int) output_1)) {
    return false;
  }

  unsigned int output_2 = get_next_row(cur_row, 'w');
  if (!assert_equals_int("output_2", 2, (int) output_2)) {
    return false;
  }
...
bool test_get_next_col() {
  // TODO: Implement this function.
    unsigned int cur_col = 3;

  unsigned int output_1 = get_next_col(cur_col, '>');
  if (!assert_equals_int("output_1", 4, (int) output_1)) {
    return false;
  }

  unsigned int output_2 = get_next_col(cur_col, 'A');
  if (!assert_equals_int("output_2", 2, (int) output_2)) {
    return false;
  }
  return true;
